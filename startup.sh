...
celery -A ESIRecruiter beat -l INFO -S django_celery_beat.schedulers:DatabaseScheduler --logfile /home/site/logs/chapman-experiments-dev/celery_beat.log --detach
