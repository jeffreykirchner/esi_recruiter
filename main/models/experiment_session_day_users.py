...
class ExperimentSessionDayUsers(models.Model):        
    ...
    experiment_session_day = models.ForeignKey(ExperimentSessionDays, on_delete=models.CASCADE, null = True, related_name='ESDU_b')                                                                                               
    ...
    def json_subjectInfo(self):
        ...
        return{
            ...
            "date_html":self.experiment_session_day.getDateStringHTML(),
   ...
   #return a list of values for a earnings csv file
    def csv_earnings(self):
        ...
        s.append(self.user.profile.public_id)
