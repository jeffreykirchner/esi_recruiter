...
class experimentForm2(forms.ModelForm):   
    gender_default = forms.ModelMultipleChoiceField(label="Gender(s)", 
                                                    ...
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.gender_default",
    ...
    subject_type_default = forms.ModelMultipleChoiceField(label="Subject Type(s)",
                                                    ...
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.subject_type_default",
                                                                                        "v-on:change":"mainFormChange2",
                                                                                        "class":"selectpicker",
                                                                                        "size":"4"}))
    experience_level_default = forms.ModelChoiceField(label="Experience Level",
                                                    ...
                                                    widget=forms.Select(attrs={"v-model":"experiment.experience_level_default",
                                                                                "v-on:change":"mainFormChange2"}))
    institutions_exclude_default = forms.ModelMultipleChoiceField(label="Exclude Institution Experience",
                                                    required=False,
                                                    queryset=institutions.objects.all().order_by("name"),
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.institutions_exclude_default",
                                                                                        "v-on:change":"mainFormChange2",
                                                                                        "class":"selectpicker",
                                                                                        "size":"10"}))
    institutions_include_default = forms.ModelMultipleChoiceField(label="Include Institution Experience",
                                                    required=False,
                                                    queryset=institutions.objects.all().order_by("name"),
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.institutions_include_default",
                                                                                        "v-on:change":"mainFormChange2",
                                                                                        "class":"selectpicker",
                                                                                        "size":"10"}))
    experiments_exclude_default = forms.ModelMultipleChoiceField(label="Exclude Experiment Experience",
                                                    required=False,
                                                    queryset=experiments.objects.all().order_by("title"),
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.experiments_exclude_default",
                                                                                        "v-on:change":"mainFormChange2",
                                                                                        "class":"selectpicker",
                                                                                        "size":"12"}))
    experiments_include_default = forms.ModelMultipleChoiceField(label="Include Experiment Experience",
                                                    required=False,
                                                    queryset=experiments.objects.all().order_by("title"),
                                                    widget = forms.SelectMultiple(attrs={"v-model":"experiment.experiments_include_default",
                                                                                        "v-on:change":"mainFormChange2",
                                                                                        "class":"selectpicker",
                                                                                        "size":"12"}))                                                                                                                                                                                                                                                                       
