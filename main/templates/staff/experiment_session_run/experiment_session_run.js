...
var app = Vue.createApp({
    ...
    data(){return{
        ...
        bumpButtonText : '<i class="fa fa-arrow-start" aria-hidden="true"></i> Bump',
        noShowButtonText : '<i class="fa fa-arrow-start" aria-hidden="true"></i> No Show',
        attendButtonText : '<i class="fa fa-arrow-start" aria-hidden="true"></i> Attend',
